...
class CPOBuffer:
    ...
    def __init__(self, size, 
                 ...
                 gamma=0.99, lam=0.95,
                 cost_gamma=0.99, cost_lam=0.95, bysafegym=False, envcd2=True):
        print(obs_shape, act_shape, bysafegym)
        self.envcd2 = envcd2
        if bysafegym:
        ...
        #print('act_shape', self.act_buf.shape)
        ...
        #print('buff shape: ', self.obs_buf.shape, self.act_buf.shape)
        # 6000, 1, 60 / 6000, 1, 2
